...
>>>>>>>> parent of b915fd0 (Landing page Darkmode fix):public/build/assets/auth-layout-CcLsRkqU.js
========
import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-TiWiJ44Q.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-CyBWSRjn.js";import{j as p}from"./helpers-Skz8l5S4.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-O0W2G3Bx.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
>>>>>>>> parent of ccbe2ff (fix):public/build/assets/auth-layout-BcKvhveG.js
                .bg-primary {
