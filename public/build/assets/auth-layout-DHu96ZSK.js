import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-CdXbmeNJ.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-DrKqFaRf.js";import{j as p}from"./helpers-B2ek5Kdc.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-BudWrizC.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
                .bg-primary {
