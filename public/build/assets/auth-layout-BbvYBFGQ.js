import{j as r}from"./ui-DGvuKKXy.js";import{u as n,L as c}from"./app-BgBGg3qm.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-C9O-5lxH.js";import{j as p}from"./helpers-CxqFzcNl.js";import{A as h}from"./application-logo-CKeMurV_.js";import{C as u}from"./cookie-consent-CAB9BXPP.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
                .bg-primary {
