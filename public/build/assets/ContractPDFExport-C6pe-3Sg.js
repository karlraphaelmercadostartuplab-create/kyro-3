const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-CmlYedri.js","./vendor-CcMVubkO.js","./app-b7auepyX.js","./ui-CFOo-GGi.js","./app-CQG9E_-B.css","./app-DBTt_SJT.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-b7auepyX.js";import{j as i}from"./ui-CFOo-GGi.js";import{B as x}from"./button-BIxgaAmS.js";import{a as f,b,c as h}from"./tooltip-D0FDZQLm.js";import{f as v,a as n,k as p}from"./helpers-gUp7ZK3C.js";import{u as _}from"./useTranslation-B0d81bcl.js";import{D as y}from"./download-DpWzK9fg.js";/* empty css            */import"./vendor-CcMVubkO.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-DrcJ8Itn.js";import"./index-q_WbhzOA.js";import"./createLucideIcon-Dov4NOxw.js";function A({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-CmlYedri.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{A as default};
