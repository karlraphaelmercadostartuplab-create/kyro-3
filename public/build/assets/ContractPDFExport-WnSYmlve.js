const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-DiCn6C77.js","./ui-DGvuKKXy.js","./pdf-CEvjGbCX.js"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-BgBGg3qm.js";import{j as i}from"./ui-DGvuKKXy.js";import{B as x}from"./button-CGddjOjT.js";import{a as f,b,c as h}from"./tooltip-Ywngswd1.js";import{f as v,a as r,k as p}from"./helpers-CxqFzcNl.js";import{u as _}from"./useTranslation-Q29AW1U9.js";import{D as y}from"./download-BRucDGlu.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-DrcJ8Itn.js";import"./index-CW7EGUsP.js";import"./createLucideIcon-B_GTT-kz.js";function N({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var n;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-DiCn6C77.js").then(o=>o.h),__vite__mapDeps([0,1,2]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{N as default};
