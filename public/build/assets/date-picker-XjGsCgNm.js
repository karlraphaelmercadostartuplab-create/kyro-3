<<<<<<<< HEAD:public/build/assets/date-picker-CIdwtoRu.js
<<<<<<<< HEAD:public/build/assets/date-picker-CIdwtoRu.js
import{j as e}from"./ui-CFOo-GGi.js";import{r as C}from"./vendor-CcMVubkO.js";import{D}from"./react-datepicker-Dd-klruE.js";import{c as d}from"./utils-DrcJ8Itn.js";import{B as S}from"./button-BIxgaAmS.js";import{P,a as E,b as N}from"./popover-CZ2F5o5a.js";import{u as $}from"./useTranslation-CMEABpT6.js";import{C as B}from"./calendar-DvmJ2XsD.js";function L({value:a,onChange:c,placeholder:i,className:s,id:p,required:l,maxDate:k,minDate:u,showYearDropdown:h=!0,showMonthDropdown:g=!0,style:m}){const{t:w}=$(),[_,n]=C.useState(!1),f=r=>r?new Date(r):null,x=r=>{if(!r)return"";const o={year:"numeric",month:"short",day:"numeric"};return r.toLocaleDateString("en-US",o)},t=f(a),v=r=>{if(r){const o=r.getFullYear(),b=String(r.getMonth()+1).padStart(2,"0"),y=String(r.getDate()).padStart(2,"0"),j=`${o}-${b}-${y}`;c(j),n(!1)}else c("")};return e.jsxs("div",{className:d("w-full",s),children:[p&&e.jsx("input",{id:p,type:"hidden",value:a||"",required:l}),e.jsxs(P,{open:_,onOpenChange:n,children:[e.jsx(E,{asChild:!0,children:e.jsxs(S,{variant:"outline",className:d("w-full justify-start text-left font-normal h-10",!a&&"text-muted-foreground"),style:m,children:[e.jsx(B,{className:"mr-2 h-4 w-4"}),a&&t?x(t):i||w("Select date")]})}),e.jsx(N,{className:"w-auto p-0",align:"start",children:e.jsx("div",{className:"date-picker-wrapper",children:e.jsx(D,{selected:t,onChange:v,inline:!0,showPopperArrow:!1,maxDate:k,minDate:u,showYearDropdown:h,showMonthDropdown:g,dropdownMode:"select",yearDropdownItemNumber:100})})})]}),e.jsx("style",{children:`
========
import{j as e}from"./ui-CFOo-GGi.js";import{r as C}from"./vendor-CcMVubkO.js";import{D}from"./react-datepicker-Dd-klruE.js";import{c as d}from"./utils-DrcJ8Itn.js";import{B as S}from"./button-BIxgaAmS.js";import{P,a as E,b as N}from"./popover-CZ2F5o5a.js";import{u as $}from"./useTranslation-2pr8-TG8.js";import{C as B}from"./calendar-DvmJ2XsD.js";function L({value:a,onChange:c,placeholder:i,className:s,id:p,required:l,maxDate:k,minDate:u,showYearDropdown:h=!0,showMonthDropdown:g=!0,style:m}){const{t:w}=$(),[_,n]=C.useState(!1),f=r=>r?new Date(r):null,x=r=>{if(!r)return"";const o={year:"numeric",month:"short",day:"numeric"};return r.toLocaleDateString("en-US",o)},t=f(a),v=r=>{if(r){const o=r.getFullYear(),b=String(r.getMonth()+1).padStart(2,"0"),y=String(r.getDate()).padStart(2,"0"),j=`${o}-${b}-${y}`;c(j),n(!1)}else c("")};return e.jsxs("div",{className:d("w-full",s),children:[p&&e.jsx("input",{id:p,type:"hidden",value:a||"",required:l}),e.jsxs(P,{open:_,onOpenChange:n,children:[e.jsx(E,{asChild:!0,children:e.jsxs(S,{variant:"outline",className:d("w-full justify-start text-left font-normal h-10",!a&&"text-muted-foreground"),style:m,children:[e.jsx(B,{className:"mr-2 h-4 w-4"}),a&&t?x(t):i||w("Select date")]})}),e.jsx(N,{className:"w-auto p-0",align:"start",children:e.jsx("div",{className:"date-picker-wrapper",children:e.jsx(D,{selected:t,onChange:v,inline:!0,showPopperArrow:!1,maxDate:k,minDate:u,showYearDropdown:h,showMonthDropdown:g,dropdownMode:"select",yearDropdownItemNumber:100})})})]}),e.jsx("style",{children:`
>>>>>>>> parent of b915fd0 (Landing page Darkmode fix):public/build/assets/date-picker-B9iRrZyd.js
========
import{j as e}from"./ui-CFOo-GGi.js";import{r as C}from"./vendor-CcMVubkO.js";import{D}from"./react-datepicker-Dd-klruE.js";import{c as d}from"./utils-DrcJ8Itn.js";import{B as S}from"./button-BIxgaAmS.js";import{P,a as E,b as N}from"./popover-CZ2F5o5a.js";import{u as $}from"./useTranslation-BNP7c0b6.js";import{C as B}from"./calendar-DvmJ2XsD.js";function L({value:a,onChange:c,placeholder:i,className:s,id:p,required:l,maxDate:k,minDate:u,showYearDropdown:h=!0,showMonthDropdown:g=!0,style:m}){const{t:w}=$(),[_,n]=C.useState(!1),f=r=>r?new Date(r):null,x=r=>{if(!r)return"";const o={year:"numeric",month:"short",day:"numeric"};return r.toLocaleDateString("en-US",o)},t=f(a),v=r=>{if(r){const o=r.getFullYear(),b=String(r.getMonth()+1).padStart(2,"0"),y=String(r.getDate()).padStart(2,"0"),j=`${o}-${b}-${y}`;c(j),n(!1)}else c("")};return e.jsxs("div",{className:d("w-full",s),children:[p&&e.jsx("input",{id:p,type:"hidden",value:a||"",required:l}),e.jsxs(P,{open:_,onOpenChange:n,children:[e.jsx(E,{asChild:!0,children:e.jsxs(S,{variant:"outline",className:d("w-full justify-start text-left font-normal h-10",!a&&"text-muted-foreground"),style:m,children:[e.jsx(B,{className:"mr-2 h-4 w-4"}),a&&t?x(t):i||w("Select date")]})}),e.jsx(N,{className:"w-auto p-0",align:"start",children:e.jsx("div",{className:"date-picker-wrapper",children:e.jsx(D,{selected:t,onChange:v,inline:!0,showPopperArrow:!1,maxDate:k,minDate:u,showYearDropdown:h,showMonthDropdown:g,dropdownMode:"select",yearDropdownItemNumber:100})})})]}),e.jsx("style",{children:`
>>>>>>>> parent of ccbe2ff (fix):public/build/assets/date-picker-XjGsCgNm.js
