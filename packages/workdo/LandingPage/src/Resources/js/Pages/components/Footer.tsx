...
const FOOTER_VARIANTS = {
    ...
    footer2: {
        ...
        companyName: 'text-xl font-bold text-gray-900',
    ...
    footer4: {
        ...
        companyName: 'text-2xl font-bold text-gray-900 mb-6',
...
export default function Footer({ settings }: FooterProps) {
    ...
    const companyName = settings?.company_name || 'AccountGo SaaS';
    const description = sectionData.description || 'The complete business management solution for modern enterprises.';
    const contactEmail = settings?.contact_email || 'support@accountgosaas.com';
