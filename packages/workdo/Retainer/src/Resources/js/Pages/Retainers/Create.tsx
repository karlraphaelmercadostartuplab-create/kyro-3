...
import { RetainerItem } from './types';
...
export default function Create() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        retainer_date: new Date().toISOString().split('T')[0],
        due_date: '',
        customer_id: '',
        warehouse_id: '',
        payment_terms: '',
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[
                ...
                {label: t('Create Retainer')}
            ]}
            pageTitle={t('Create Retainer')}
        >
            <Head title={t('Create Retainer')} />
