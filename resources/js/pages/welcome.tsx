                ...
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end gap-1">
                                <Link
                                    href={route("home")}
                        ...
                        <section
                            id="about-section"
                            className="mt-20 py-16 border-t border-gray-200 dark:border-zinc-700"
                        >
                            <div className="max-w-3xl">
                                ...
                                <p className="text-lg text-black/60 dark:text-white/60 mb-4">
                                    Our platform is built with modern enterprises in mind. We provide
                                    comprehensive financial management solutions that empower businesses
                                    to scale with confidence.
                                </p>
                                <p className="text-lg text-black/60 dark:text-white/60">
                                    With cutting-edge technology and dedicated support, we help thousands
                                    of companies around the world manage their finances, streamline operations,
                        ...
                        >
                            <div className="max-w-4xl">
                                ...
                                <div className="grid gap-6 lg:grid-cols-3">
                                    <div className="rounded-lg bg-white p-8 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                        <h3 className="text-xl font-semibold text-black dark:text-white mb-2">
                                            Starter
                                        </h3>
                                        <p className="text-3xl font-bold text-black dark:text-white mb-6">
                                            $29<span className="text-lg text-black/60 dark:text-white/60">/mo</span>
                                        </p>
                                        ...
                                        <Link
                                            href={route("register")}
                                            className="inline-block w-full text-center rounded-md bg-[#FF2D20] px-4 py-2 text-white transition hover:bg-[#FF2D20]/90"
                                        >
                                            Get Started
                                        </Link>
                                    </div>

                                    <div className="rounded-lg bg-white p-8 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-2 ring-[#FF2D20] dark:bg-zinc-900 dark:ring-[#FF2D20]">
                                        <h3 className="text-xl font-semibold text-black dark:text-white mb-2">
                                            Professional
                                        </h3>
                                        <p className="text-3xl font-bold text-black dark:text-white mb-6">
                                            $79<span className="text-lg text-black/60 dark:text-white/60">/mo</span>
                                        </p>
                                        <p className="text-black/60 dark:text-white/60 mb-6">
                                    ...
                                    <div className="rounded-lg bg-white p-8 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800">
                                        ...
                                        <p className="text-3xl font-bold text-black dark:text-white mb-6">
                                            Custom<span className="text-lg text-black/60 dark:text-white/60"> pricing</span>
                                        </p>
                                        <p className="text-black/60 dark:text-white/60 mb-6">
                        ...
                        <footer className="py-16 border-t border-gray-200 dark:border-zinc-700">
                            ...
                            <div className="border-t border-gray-200 dark:border-zinc-700 pt-8 text-center text-sm text-black/60 dark:text-white/60">
