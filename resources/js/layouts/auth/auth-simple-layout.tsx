...
export default function AuthSimpleLayout({
    ...
    const logoSrc = 
        settings.themeMode === 'dark' 
            ? (settings.logo_light || settings.logo_dark) : (settings.logo_dark || settings.logo_light);
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg lg:p-8 p-4 lg:pt-5 shadow-sm">
                            ...
                            <div className="text-center mb-4">
                                <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-1.5">{title}</h1>
                                <div 
